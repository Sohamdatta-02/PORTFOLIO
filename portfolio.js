...
//     const backgroundImage = document.getElementsByClassName('background-circle');
//     const imageDetails = backgroundImage[0].getBoundingClientRect();
//     const spanDetails = span[1].getBoundingClientRect();
//     console.log( spanDetails.left);

//     if(imageDetails.left>spanDetails.left || imageDetails.right<spanDetails.right){
